...
function draw() {
  ...
  if(gameState === 0){
  	...
  	textFont("Ayuthaya");
  	fill(123,12,89);
  	text("If the yellow boxes touch you 5 times then you loose", 100, 200); 
	...
	textSize(30);
  	textFont("Ayuthaya");
  	fill(123,12,89);
  	text("Use MouseY to Go Up and Down", 100, 400);

	textSize(30);
  	textFont("Ayuthaya");
  	fill(123,12,89);
  	text("Press space to start", 100, 500);
}
